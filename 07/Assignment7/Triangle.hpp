...
public:
		...
		: v0(_v0), v1(_v1), v2(_v2), m(_m)
	{
		...
		area = crossProduct(e1, e2).norm() * 0.5f;//三角形的面积
	}
...
{
public:
	MeshTriangle(const std::string& filename, Material* mt = new Material(),Vector3f Trans=Vector3f(0),Vector3f Scale=Vector3f(1.0))
	{
		objl::Loader loader;
